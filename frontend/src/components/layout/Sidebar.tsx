...
const roleNavItems: Record<string, NavItem[]> = {
  super_admin: [
    ...
    { label: 'Dataset Browser', path: '/admin/dataset', icon: '📦' },
    { label: 'GIS Map', path: '/admin/gis', icon: '🗺️' },
    { label: 'Compensation Report', path: '/admin/compensation-report', icon: '💰' },
  ...
  state_authority: [
    ...
    { label: 'Dataset Browser', path: '/state/dataset', icon: '📦' },
    { label: 'GIS Map', path: '/state/gis', icon: '🗺️' },
    { label: 'Compensation Report', path: '/state/compensation-report', icon: '💰' },
